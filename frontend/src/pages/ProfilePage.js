...
const ProfilePage = () => {
  ...
  return (
    <div className="flex-grow bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white w-full max-w-10xl">
      {/* Profile Header and Tabs Sticky Group */}
      <div className="sticky top-0 z-20">
        {/* Profile Header */}
        <div className="border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
          <div className="flex sticky items-center px-4 py-3">
          ...
          <div className="p-4 pt-20">
            ...
            <div className="flex space-x-4 text-gray-900 dark:text-white text-sm mb-4">
              <div className="flex items-center space-x-1 group">
                <span className="font-bold text-lg group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">{followingCount}</span>
              ...
              <div className="flex items-center space-x-1 group">
                <span className="font-bold text-lg group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">{followersCount}</span>
        ...
        <div className="sticky top-[110px] z-30 mx-4 mb-4">
          <div className="border border-gray-200 dark:border-gray-700 flex justify-around overflow-x-auto p-2 bg-white dark:bg-gray-900 rounded-xl shadow-md">
            {tabs.map((tab) => (
              <button
                key={tab}
